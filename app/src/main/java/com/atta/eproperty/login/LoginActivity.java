...
public class LoginActivity extends AppCompatActivity implements LoginContract.View ,View.OnClickListener, CompoundButton.OnCheckedChangeListener{
    ...
    public void navigateToMain() {
        ...
        Intent intent = new Intent(com.atta.eproperty.login.LoginActivity.this,MainActivity.class);
    ...
    public void navigateToRegister() {
        ...
        Intent intent = new Intent(com.atta.eproperty.login.LoginActivity.this,RegisterActivity.class);
        startActivity(intent);
    }
