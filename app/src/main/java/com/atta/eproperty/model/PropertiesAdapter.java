...
public class PropertiesAdapter extends RecyclerView.Adapter<PropertiesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        final String imageURL = property.getImageUrl();
        fragmentsPresenter.getRetrofitImage(myViewHolder.dishImage, imageURL);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dishImage = itemView.findViewById(R.id.property_image);
